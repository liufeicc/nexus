...
export function useDynamicIslandUI({
  ...
  useEffect(() => {
    ...
    const observer = new ResizeObserver(() => {
      ...
      resizeTimer = setTimeout(() => {
        ...
        const userPrefHeight = userPrefOpen ? 500 : 0
        const panelExtra = Math.max(taskPanelHeight, skillPanelHeight, memoryPanelHeight, historyPanelHeight, userPrefHeight)
  ...
  }, [standalone, taskPanelOpen, skillPanelOpen, memoryPanelOpen, historyPanelOpen, userPrefOpen])
